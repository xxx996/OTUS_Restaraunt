...
3. Добавить реквизит для ввода электронной почты (доступно, кога Электронный чек = ИСТИНА)
4. Добавить кнопку "Оплатить заказ", при нажати
5. Добавить кнопку "Назад" для возврата в корзину

...
**`Задача 10.2:`** Интеграции с системой управления роботами и уведомлениями
<br>
**Описание задачи:** Разработать бэкенд-логику для взаимодействия компонента оплаты с компонентом управления роботов.
<br>
Настроить передачу инфомарции об оформленном заказе менеджеру для проведения расчета с клиентом. 

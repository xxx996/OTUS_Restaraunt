...
**`Задача 7.3:`** Интеграция с компонентом меню 
<br>
**Описание задачи:** Разработать бэкенд-логику для взаимодействия интерфейса корзины с компоненотом меню. Получать корректную информацию по добавленнным блюдам из меню. 

...
- Добавить кнопку "Очистить корзину", при нажатии очищается вся корзина
- Добавить кнопку "Оформить заказ", при нажатии переходить на [форму оплаты](../uix.md#wf8)
...
- Добавить возможность регулировать количество блюд нажатием на кнопки "+" и "-"
